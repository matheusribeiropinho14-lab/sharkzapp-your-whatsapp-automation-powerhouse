...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SharkZapp — Automação de vendas no WhatsApp" },
      {
        name: "description",
        content:
          "Plataforma brasileira de automação de WhatsApp com IA, disparos, funis, CRM e caixa de entrada compartilhada.",
      },
      { name: "author", content: "SharkZapp" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "SharkZapp" },
